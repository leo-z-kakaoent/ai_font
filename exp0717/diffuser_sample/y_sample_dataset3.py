...
class SamplingDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        content_path = f"{self.args.contentfd}/{self.args.content_font}/{self.args.content_font}__{content}.png"
        style_path = f"{self.args.stylefd}/{self.target_font}/{self.target_font}__{content}.png"
