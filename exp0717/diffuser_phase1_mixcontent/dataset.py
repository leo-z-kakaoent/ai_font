...
class FontDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        content_font = random.choice([f for f in self.fonts if font != f])
        content = random.choice(list(set(self.fontdict[font]).intersection(set(self.fontdict[content_font]))))

        content_img_path = f"{self.args.content_path}/{content_font}/{content_font}__{content}.png"
