...
for epoch in range(num_train_epochs):
    ...
    for step, samples in enumerate(train_dataloader):
        ...
        if global_step % 10000 == 0:
            torch.save(unet.state_dict(), "data/model/ex0_unet_%s.pth"%str(global_step))
            torch.save(style_encoder.state_dict(), "data/model/ex0_style_encoder_%s.pth"%str(global_step))
            torch.save(content_encoder.state_dict(), "data/model/ex0_content_encoder_%s.pth"%str(global_step))
