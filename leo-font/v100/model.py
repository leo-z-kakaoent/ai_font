...
class FontDiffuserModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        style_img_feature, style_h, style_residual_features = self.style_encoder(style_images)
        ...
        # content_residual_features.append(style_residual_features[-1])
        # content_residual_features.append(style_residual_features)

        # Get the content feature from reference image
        style_content_feature, style_content_res_features = self.content_encoder(style_images)
        style_content_res_features.append(style_content_feature)
        # style_content_res_features.append(style_residual_features[-1])
        # style_content_res_features.append(style_residual_features)
