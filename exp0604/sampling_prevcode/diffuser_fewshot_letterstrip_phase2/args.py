class SampleArgs:
    def __init__(self):
        ...
        self.datapath = "/home/jupyter/ai_font/data/exp0604"
        self.contentfont = '시스템 굴림'
        self.testfont = "카엔플린"
        self.testmappath = "/home/jupyter/ai_font/data/exp0604/pickle/카엔플린_testmap.pickle"
        self.batchsize = 96
        self.savefd = "/home/jupyter/ai_font/data/reports/exp0604/fewshot_letterstrip_fontdif"
        self.tag = 'fewshot_letterstrip_fontdif'
