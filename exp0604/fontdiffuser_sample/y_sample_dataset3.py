...
class SamplingDataset(Dataset):
    ...
    def __init__(self, args, target_font):
        ...
        self.target_letters = [k for k in self.ak if os.path.exists(f"{self.path}/test_handcut_assembled/{self.target_font}/{self.target_font}__closing__{k}.png")]
    ...
    def __getitem__(self, index):
        ...
        style_path = f"{self.path}/test_handcut_assembled/{self.target_font}/{self.target_font}__closing__{content}.png"
