...
class StyleRSIUpBlock2D(nn.Module):
    ...
    def forward(
        ...
        style_content_feat = style_structure_features[-self.upblock_index-3]
        # print("[f.shape for f in style_structure_features]", [f.shape for f in style_structure_features])
