...
class OffsetRefStrucInter(nn.Module):
    ...
    def __init__(
        ...
        self.style_channel_matcher = nn.Conv2d(256, 128, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, res_hidden_states, style_content_hidden_states):
        ...
        # style projecter
        # print("attention / self.gnorm_s(style_content_hidden_states)", style_content_hidden_states.shape)
        # print("attention / self.gnorm_s", self.gnorm_s)
        
#         if self.gnorm_s.weight.shape[0] < style_content_hidden_states.shape[1]:
#             style_content_hidden_states = self.style_channel_matcher(style_content_hidden_states)
